...
(def LongTermFuelTrim
  ...
  {:db/ident :auto-vs/LongTermFuelTrim,
   ...
   :rdfs/subClassOf [{:owl/allValuesFrom :qudt/DimensionlessUnit,
                      :owl/onProperty    :qudt/unit,
                      :rdf/type          :owl/Restriction}
                     :auto-vs/ObservableSignal],
   :skos/definition
...
(def O2Current
  ...
  {:db/ident :auto-vs/O2Current,
   ...
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Current"},
   :rdfs/subClassOf [{:owl/allValuesFrom :qudt/ElectricCurrentUnit,
                      :owl/onProperty    :qudt/unit,
                      :rdf/type          :owl/Restriction}
                     :auto-vs/ObservableSignal],
   :skos/definition
...
(def O2Voltage
  ...
  {:db/ident :auto-vs/O2Voltage,
   ...
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Voltage"},
   :rdfs/subClassOf [{:owl/allValuesFrom :qudt/EnergyPerElectricChargeUnit,
                      :owl/onProperty    :qudt/unit,
                      :rdf/type          :owl/Restriction}
                     :auto-vs/ObservableSignal],
   :skos/definition
