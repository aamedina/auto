...
(def ConventionalVehicle
  ...
  {:db/ident :auto-av/ConventionalVehicle,
   ...
   :rdfs/subClassOf [:auto-av/MotorVehicle
                     {:owl/onProperty     :auto-av/isCapableToParticipateIn,
...
(def DynamicDriverTaskFallbackReadyUser
  ...
  {:db/ident :auto-av/DynamicDriverTaskFallbackReadyUser,
   ...
   :rdfs/subClassOf [{:owl/onProperty     :auto-av/isUserInWhileDASisEnagaged,
...
(def FullTripFeature
  ...
  {:db/ident :auto-av/FullTripFeature,
   ...
   :rdfs/subClassOf [{:owl/allValuesFrom :auto-av/MotorVehicleOperation,
                      :owl/onProperty    :auto-av/performs,
                      :rdf/type          :owl/Restriction}
                     {:owl/onProperty     :auto-av/isResultOf,
                      :owl/someValuesFrom {:owl/unionOf
...
(def Passenger
  ...
  {:db/ident :auto-av/Passenger,
   ...
   :rdfs/label {:rdf/language "en",
                :rdf/value    "passenger"},
   :rdfs/subClassOf [:auto-av/InVehicleUser
                     :auto-av/HumanUser
...
(def ^{:private true} Task
  {:db/ident :auto-cc/Task,
   :rdf/type :owl/Class})

(def ^{:private true} LandVehicle
